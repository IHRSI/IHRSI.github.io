document.addEventListener('DOMContentLoaded', () => {
    ...
    const particleConfigs = {
        ...
        'glacier-experience': { class: 'p-spark', count: 35, size: [1.5, 3], duration: [2.5, 4.5] },
    ...
    const logLines = {
        ...
        'glacier-experience': 'Altitude: 4,000m. A campfire on the glacier. Forging real-world experience in the embers.',
